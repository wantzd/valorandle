...
const PLAYERS_DB = [
  ...
  // ── FURIA ────────────────────────────────────────────────
  { id:"nerve",     name:"nerve",     displayName:"nerve",     country:"EUA",            countryCode:"US", team:"FURIA",         league:"VCT Americas", leagueId:"americas", age:23, role:"IGL",       yearsActive:6, titles:["Nenhum"] },
  ...
  { id:"artzin",    name:"artzin",    displayName:"artzin",    country:"Brasil",          countryCode:"BR", team:"FURIA",         league:"VCT Americas", leagueId:"americas", age:22, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"valyn",     name:"valyn",     displayName:"valyn",     country:"EUA",            countryCode:"US", team:"G2 Esports",    league:"VCT Americas", leagueId:"americas", age:23, role:"IGL",        yearsActive:4, titles:["Champions 2024"] },
  ...
  { id:"Ethan",     name:"Ethan",     displayName:"Ethan",     country:"EUA",            countryCode:"US", team:"NRG",           league:"VCT Americas", leagueId:"americas", age:26, role:"IGL",        yearsActive:6, titles:["Champions 2025","Masters Reykjavik 2022"] },
  ...
  { id:"vora",      name:"vora",      displayName:"vora",      country:"EUA",            countryCode:"US", team:"100 Thieves",   league:"VCT Americas", leagueId:"americas", age:21, role:"IGL",        yearsActive:3, titles:["Nenhum"] },
  ...
  { id:"penny",     name:"penny",     displayName:"penny",     country:"Canadá",          countryCode:"CA", team:"Cloud9",        league:"VCT Americas", leagueId:"americas", age:23, role:"IGL",        yearsActive:5, titles:["Nenhum"] },
  ...
  // ── LEVIATÁN ──────────────────────────────────────────────
  { id:"kiNgg",     name:"kiNgg",     displayName:"kiNgg",     country:"Chile",           countryCode:"CL", team:"LEVIATÁN",      league:"VCT Americas", leagueId:"americas", age:24, role:"IGL",        yearsActive:5, titles:["VCT Americas 2023","Masters Tokyo 2023"] },
  ...
  // ── ENVY ──────────────────────────────────────────────────
  { id:"Rossy",     name:"Rossy",     displayName:"Rossy",     country:"EUA",            countryCode:"US", team:"ENVY",          league:"VCT Americas", leagueId:"americas", age:23, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"P0PPIN",    name:"P0PPIN",    displayName:"P0PPIN",    country:"EUA",            countryCode:"US", team:"ENVY",          league:"VCT Americas", leagueId:"americas", age:21, role:"IGL",        yearsActive:3, titles:["Nenhum"] },
  ...
  // ── Sentinels ─────────────────────────────────────────────
  { id:"johnqt",    name:"johnqt",    displayName:"johnqt",    country:"Marrocos",        countryCode:"MA", team:"Sentinels",     league:"VCT Americas", leagueId:"americas", age:27, role:"IGL",        yearsActive:5, titles:["Nenhum"] },
  ...
  // ── LOUD ──────────────────────────────────────────────────
  { id:"erde",      name:"erde",      displayName:"erde",      country:"Chile",           countryCode:"CL", team:"LOUD",          league:"VCT Americas", leagueId:"americas", age:18, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  // ── KRÜ Esports ───────────────────────────────────────────
  { id:"saadhak",   name:"saadhak",   displayName:"saadhak",   country:"Argentina",       countryCode:"AR", team:"KRÜ Esports",   league:"VCT Americas", leagueId:"americas", age:29, role:"IGL",        yearsActive:6, titles:["Champions 2022","Masters Copenhagen 2022","VCT Americas 2022"] },
  ...
  // ── Fnatic ────────────────────────────────────────────────
  { id:"Boaster",   name:"Boaster",   displayName:"Boaster",   country:"Reino Unido",    countryCode:"GB", team:"Fnatic",        league:"VCT EMEA", leagueId:"emea", age:28, role:"IGL",        yearsActive:6, titles:["Champions 2021"] },
  ...
  // ── NAVI ─────────────────────────────────────────────────
  { id:"ANGE1",     name:"ANGE1",     displayName:"ANGE1",     country:"Ucrânia",         countryCode:"UA", team:"NAVI",          league:"VCT EMEA", leagueId:"emea", age:31, role:"IGL",        yearsActive:7, titles:["Nenhum"] },
  ...
  { id:"Bpx",       name:"Bpx",       displayName:"Bpx",       country:"Alemanha",        countryCode:"DE", team:"Team Liquid",   league:"VCT EMEA", leagueId:"emea", age:24, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"pAura",     name:"pAura",     displayName:"pAura",     country:"Alemanha",        countryCode:"DE", team:"Giants",        league:"VCT EMEA", leagueId:"emea", age:23, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"Turko",     name:"Turko",     displayName:"Turko",     country:"Turquia",         countryCode:"TR", team:"BBL Esports",   league:"VCT EMEA", leagueId:"emea", age:23, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"riens",     name:"riens",     displayName:"riens",     country:"França",          countryCode:"FR", team:"Karmine Corp",  league:"VCT EMEA", leagueId:"emea", age:21, role:"IGL",        yearsActive:3, titles:["Nenhum"] },
  { id:"ShahZam",   name:"ShahZam",   displayName:"ShahZam",   country:"EUA",            countryCode:"US", team:"Karmine Corp",  league:"VCT EMEA", leagueId:"emea", age:28, role:"IGL",        yearsActive:6, titles:["Nenhum"] },
  ...
  { id:"d4v41",     name:"d4v41",     displayName:"d4v41",     country:"Singapura",       countryCode:"SG", team:"Paper Rex",     league:"VCT Pacific", leagueId:"pacific", age:26, role:"IGL",        yearsActive:5, titles:["Masters Bangkok 2025"] },
  ...
  { id:"Laz",       name:"Laz",       displayName:"Laz",       country:"Japão",           countryCode:"JP", team:"ZETA Division", league:"VCT Pacific", leagueId:"pacific", age:25, role:"IGL",        yearsActive:5, titles:["Nenhum"] },
  ...
  // ── DRX ──────────────────────────────────────────────────
  { id:"stax",      name:"stax",      displayName:"stax",      country:"Coreia do Sul",   countryCode:"KR", team:"DRX",           league:"VCT Pacific", leagueId:"pacific", age:26, role:"IGL",        yearsActive:5, titles:["Nenhum"] },
  ...
  { id:"Munchkin",  name:"Munchkin",  displayName:"Munchkin",  country:"Coreia do Sul",   countryCode:"KR", team:"Gen.G",         league:"VCT Pacific", leagueId:"pacific", age:24, role:"IGL",        yearsActive:5, titles:["Nenhum"] },
  ...
  { id:"Sylvan",    name:"Sylvan",    displayName:"Sylvan",    country:"Coreia do Sul",   countryCode:"KR", team:"T1",            league:"VCT Pacific", leagueId:"pacific", age:24, role:"IGL",        yearsActive:3, titles:["Nenhum"] },
  ...
  { id:"GMT",       name:"GMT",       displayName:"GMT",       country:"Tailândia",       countryCode:"TH", team:"Talon",         league:"VCT Pacific", leagueId:"pacific", age:23, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"Haodong",   name:"Haodong",   displayName:"Haodong",   country:"China",           countryCode:"CN", team:"EDG",           league:"VCT China", leagueId:"china", age:24, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"Wuwu",      name:"Wuwu",      displayName:"Wuwu",      country:"China",           countryCode:"CN", team:"BLG",           league:"VCT China", leagueId:"china", age:24, role:"IGL",        yearsActive:4, titles:["Nenhum"] },

  // ── FunPlus Phoenix (FPX) ─────────────────────────────────
  { id:"CHICHOO",   name:"CHICHOO",   displayName:"CHICHOO",   country:"China",           countryCode:"CN", team:"FPX",           league:"VCT China", leagueId:"china", age:25, role:"IGL",        yearsActive:4, titles:["Nenhum"] },
  ...
  { id:"Rock",      name:"Rock",      displayName:"Rock",      country:"China",           countryCode:"CN", team:"Trace",         league:"VCT China", leagueId:"china", age:25, role:"IGL",        yearsActive:5, titles:["Nenhum"] },
