...
export const MAPS_I18N = {
  'pt-BR': {
    ...
    imgPlaceholder:'Carregando imagem…', mapPlaceholder:'Selecione o mapa para ver o minimapa',
  ...
  'en': {
    ...
    imgPlaceholder:'Loading image…', mapPlaceholder:'Select a map to see its minimap',
