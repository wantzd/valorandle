...
<div class="game-screen">
  ...
  <header class="game-header">
    <div class="header-left">
      <a class="back-btn" href="/" id="back-btn">← Lobby</a>
    ...
    <div class="header-right">
      <a class="lang-btn {isPT ? 'active' : ''}" href="/game" aria-label="Português">PT</a>
      <a class="lang-btn {!isPT ? 'active' : ''}" href="/en/game" aria-label="English">EN</a>
...
<style>
  ...
  .back-btn { background:transparent; border:1px solid var(--border2); color:var(--text-dim); font-family:var(--font-mono); font-size:0.65rem; letter-spacing:0.1em; padding:0.38rem 0.8rem; cursor:pointer; border-radius:3px; transition:all 0.2s; text-decoration:none; }
  ...
  .league-tag { font-family:var(--font-mono); font-size:0.55rem; letter-spacing:0.12em; text-transform:uppercase; padding:0.14rem 0.5rem; border-radius:2px; font-weight:700; display:none; }
  .streak-chip { font-family:var(--font-mono); font-size:0.65rem; font-weight:700; letter-spacing:0.08em; background:var(--surface2); border:1px solid var(--border2); color:var(--text-mid); padding:0.3rem 0.6rem; border-radius:3px; display:flex; align-items:center; gap:0.3rem; }
  ...
  .guess-btn { background:var(--red); border:none; color:#fff; font-family:var(--font-mono); font-size:0.8rem; font-weight:700; letter-spacing:0.08em; padding:0.8rem 1.4rem; border-radius:0 4px 4px 0; cursor:pointer; transition:all 0.2s; }
  ...
  .col-header { font-family:var(--font-mono); font-size:0.58rem; font-weight:700; letter-spacing:0.16em; text-transform:uppercase; color:var(--text-dim); text-align:center; padding:0.45rem 0.25rem; background:var(--surface); border:1px solid var(--border); border-radius:3px; }
  ...
  :global(.cell-value) { font-family:var(--font-ui); font-size:0.8rem; font-weight:600; line-height:1.3; color:var(--text); }
  :global(.cell-hint)  { font-family:var(--font-mono); font-size:0.72rem; font-weight:700; line-height:1; }
  ...
  :global(.tip-title) { font-family:var(--font-mono); font-size:0.58rem; font-weight:700; letter-spacing:0.14em; text-transform:uppercase; color:var(--text-dim); margin-bottom:0.35rem; display:block; }
  ...
  .result-status { padding:0.7rem 1.25rem; font-family:var(--font-display); font-size:0.9rem; letter-spacing:0.04em; text-transform:uppercase; border-bottom:1px solid var(--border); }
  ...
  :global(.result-graph-label), :global(.replay-label) { font-family:var(--font-mono); font-size:0.6rem; font-weight:700; letter-spacing:0.16em; text-transform:uppercase; color:var(--text-dim); margin-bottom:0.55rem; display:block; }
  ...
  :global(.btn-action) { font-family:var(--font-mono); font-size:0.68rem; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; padding:0.5rem 1rem; border-radius:3px; border:none; cursor:pointer; transition:all 0.2s; }
  ...
  :global(.toast) { position:fixed; bottom:2rem; left:50%; transform:translateX(-50%) translateY(60px); background:var(--red); color:#fff; font-family:var(--font-mono); font-size:0.75rem; font-weight:700; letter-spacing:0.08em; padding:0.6rem 1.25rem; border-radius:3px; z-index:9001; transition:transform 0.28s ease; pointer-events:none; }
  :global(.toast.show) { transform:translateX(-50%) translateY(0); }

  @media (max-width:640px) { .game-logo{font-size:1.1rem} }
  @media (max-width:600px) { .grid-container{min-width:unset} :global(.guess-row),:global(.grid-headers),:global(.guess-row-empty){grid-template-columns:110px repeat(6,1fr)} .col-header,:global(.cell-value){font-size:0.62rem} :global(.cell-hint){font-size:0.7rem} }
  ...
  #loading-overlay .lo-logo { font-family:var(--font-display); font-size:1.6rem; letter-spacing:0.12em; color:var(--text); }
