...
export function compareCountry(guess, target) {
  return {
    attr: "country",
    value: guess.country,
...
export function compareTeam(guess, target) {
  return {
    attr: "team",
    value: guess.team,
...
export function compareAge(guess, target) {
...
export function compareRole(guess, target) {
...
export function translateRole(roleStr, rolesDict) {
  if (!roleStr) return "";
...
export function compareTitles(guess, target) {
...
export function compareYearsActive(guess, target) {
...
export function formatTitles(titles) {
...
export function getDailyPlayers(players) {
...
export function getRandomPlayer(players, exclude = []) {
...
export function cleanOldDailyStates() {
  try {
...
export function generateShareText(dailyDate, roundResults, lang) {
